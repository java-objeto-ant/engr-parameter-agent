 ...
 * @date    2018-04-19
 */
package org.rmj.engr.parameter.agent;
...
import org.rmj.engr.parameter.base.AffiliatedCompany;
import org.rmj.engr.parameter.pojo.UnitAffiliatedCompany;

public class XMAffiliatedCompany implements XMRecord{
    public XMAffiliatedCompany(GRider foGRider, String fsBranchCD, boolean fbWithParent){
        this.poGRider = foGRider;
        if (foGRider != null){
            this.pbWithParent = fbWithParent;
            this.psBranchCd = fsBranchCD;
            
            poControl = new AffiliatedCompany();
    ...
    public boolean saveRecord() {
        if(pnEditMode == EditMode.UNKNOWN){
            ...
            UnitAffiliatedCompany loResult;
    ...
    public boolean browseRecord(String fsValue, boolean fbByCode){        
        JSONObject loJSON = searchAffiliatedCompany(fsValue, fbByCode);
        
        if(loJSON == null)
            return false;
        else
            return openRecord((String) loJSON.get("sAffiliatedCompanyCde"));
    }
    
    public JSONObject searchAffiliatedCompany(String fsValue, boolean fbByCode){
        String lsHeader = "Code»Name»ID";
        String lsColName = "sCompnyCd»sCompnyNm»dAffiliat";
        String lsColCrit = "sCompnyCd»sCompnyNm»dAffiliat";
        String lsSQL = MiscUtil.makeSelect(new UnitAffiliatedCompany());
    ...
    private AffiliatedCompany poControl;
    private UnitAffiliatedCompany poData;
    ...
    private final String pxeModuleName = "XMAffiliatedCompany";
}
