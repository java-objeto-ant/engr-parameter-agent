...
import org.rmj.engr.parameter.base.CategoryLevel2;
import org.rmj.engr.parameter.pojo.UnitCategoryLevel2;

public class XMCategoryLevel2 implements XMRecord{
    public XMCategoryLevel2(GRider foGRider, String fsBranchCD, boolean fbWithParent){
        this.poGRider = foGRider;
        if (foGRider != null){
            this.pbWithParent = fbWithParent;
            this.psBranchCd = fsBranchCD;
            
            poControl = new CategoryLevel2();
    ...
    private CategoryLevel2 poControl;
    private UnitCategoryLevel2 poData;
    ...
    private final String pxeModuleName = "XMCategoryLevel2";
}
