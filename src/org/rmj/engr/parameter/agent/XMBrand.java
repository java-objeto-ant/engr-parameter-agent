...
import org.rmj.engr.parameter.base.Brand;
import org.rmj.engr.parameter.pojo.UnitBrand;

public class XMBrand implements XMRecord{
    public XMBrand(GRider foGRider, String fsBranchCD, boolean fbWithParent){
    ...
    public boolean browseRecord(String fsValue, boolean fbByCode){        
        JSONObject loJSON = searchBrand(fsValue, fbByCode);
        
        if(loJSON == null)
            return false;
        else
            return openRecord((String) loJSON.get("sBrandCde"));
    }
    ...
    private Brand poControl;
    private UnitBrand poData;
