...
import org.rmj.engr.parameter.base.CategoryLevel4;
import org.rmj.engr.parameter.pojo.UnitCategoryLevel4;

public class XMCategoryLevel4 implements XMRecord{
    public XMCategoryLevel4(GRider foGRider, String fsBranchCD, boolean fbWithParent){
        this.poGRider = foGRider;
        if (foGRider != null){
            this.pbWithParent = fbWithParent;
            this.psBranchCd = fsBranchCD;
            
            poControl = new CategoryLevel4();
    ...
    private CategoryLevel4 poControl;
    private UnitCategoryLevel4 poData;
    ...
    private final String pxeModuleName = "XMCategoryLevel4";
}
