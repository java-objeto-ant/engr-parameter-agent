...
import org.rmj.engr.parameter.base.PromoDiscount;
import org.rmj.engr.parameter.pojo.UnitPromoDiscount;

public class XMPromoDiscount implements XMRecord{
    public XMPromoDiscount(GRider foGRider, String fsBranchCD, boolean fbWithParent){
        this.poGRider = foGRider;
        if (foGRider != null){
            this.pbWithParent = fbWithParent;
            this.psBranchCd = fsBranchCD;
            
            poControl = new PromoDiscount();
    ...
    public void setMaster(int fnCol, Object foData) {
        if (pnEditMode != EditMode.UNKNOWN){
            ...
            if(!(fnCol == poData.getColumn("cRecdStat") ||
                ...
                if (fnCol == poData.getColumn("nDiscRate") ||
    ...
    public boolean newRecord() {
        ...
        if (poData == null){
            ...
            poData.setDateFrom(poGRider.getServerDate());
            poData.setDateThru(poGRider.getServerDate());
    ...
    public boolean browseRecord(String fsValue, boolean fbByCode){        
        JSONObject loJSON = searchPromoDiscount(fsValue, fbByCode);
        
        if(loJSON == null)
            return false;
        else
            return openRecord((String) loJSON.get("sDiscIDxx"));
    }
    
    public JSONObject searchPromoDiscount(String fsValue, boolean fbByCode){
    ...
    private PromoDiscount poControl;
    private UnitPromoDiscount poData;
    ...
    private final String pxeModuleName = "XMPromoDiscount";
}
