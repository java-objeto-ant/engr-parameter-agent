...
import org.rmj.engr.parameter.base.Department;
...
public class XMDepartment implements XMRecord{
    ...
    public boolean openRecord(String fstransNox) {
        ...
        if (poData.getDepartmentID()== null){
            ShowMessageFX();
            return false;
        } else{
    ...
    public boolean browseRecord(String fsValue, boolean fbByCode){        
        JSONObject loJSON = searchDepartment(fsValue, fbByCode);
        
        if(loJSON == null)
            return false;
        else
            return openRecord((String) loJSON.get("sDeptIDxx"));
    }
    
    public JSONObject searchDepartment(String fsValue, boolean fbByCode){
        String lsHeader = "Code»Description";
        String lsColName = "sDeptIDxx»sDeptName";
        String lsColCrit = "sDeptIDxx»sDeptName";
    ...
    private final String pxeModuleName = "XMDepartment";
}
