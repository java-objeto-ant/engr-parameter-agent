...
import org.rmj.engr.parameter.base.Measure;
import org.rmj.engr.parameter.pojo.UnitMeasure;

public class XMMeasure implements XMRecord{
    public XMMeasure(GRider foGRider, String fsBranchCD, boolean fbWithParent){
        this.poGRider = foGRider;
        if (foGRider != null){
            this.pbWithParent = fbWithParent;
            this.psBranchCd = fsBranchCD;
            
            poControl = new Measure();
    ...
    public boolean browseRecord(String fsValue, boolean fbByCode){        
        JSONObject loJSON = searchMeasure(fsValue, fbByCode);
        
        if(loJSON == null)
            return false;
        else
            return openRecord((String) loJSON.get("sMeasurID"));
    }
    
    public JSONObject searchMeasure(String fsValue, boolean fbByCode){
    ...
    private Measure poControl;
    private UnitMeasure poData;
    ...
    private final String pxeModuleName = "XMMeasure";
}
