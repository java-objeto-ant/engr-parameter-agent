...
import org.rmj.engr.parameter.base.Branch;
import org.rmj.engr.parameter.pojo.UnitBranch;
...
public class XMBranch implements XMRecord{
    ...
    public boolean browseRecord(String fsValue, boolean fbByCode){        
        JSONObject loJSON = searchBranch(fsValue, fbByCode);
    ...
    public JSONObject searchBranch(String fsValue, boolean fbByCode){
    ...
    private final String pxeModuleName = "XMBranch";
}
