...
public class Category2Controller implements Initializable, IFXML {
        ...
        switch (event.getCode()){
            case F3:
                ...
                if (lnIndex == 3){
                    ...
                    lsResult = loInvType.searchInvType(txtField03.getText(), false);
                    loadMaster(3, lsResult);
                }else{
                    XMCategory loCategory = new XMCategory(poGRider, poGRider.getBranchCode(), true);
                    lsResult = loCategory.searchCategory(txtField04.getText(), false);
    ...
    private void loadRecord(){
        ...
        if (poRecord.getMaster(3) != null && !poRecord.getMaster(3).toString().isEmpty()){
            XMInventoryType loInvType = new XMInventoryType(poGRider, poGRider.getBranchCode(), true);
            lsResult = loInvType.searchInvType((String) poRecord.getMaster(3), true);
            loadMaster(3, lsResult);
        } else
            txtField03.setText("");
        ...
        if (poRecord.getMaster(4) != null && !poRecord.getMaster(4).toString().isEmpty()){
            XMCategory loCategory = new XMCategory(poGRider, poGRider.getBranchCode(), true);
            lsResult = loCategory.searchCategory((String) poRecord.getMaster(4), true);
            loadMaster(4, lsResult);
        } else
            txtField04.setText("");
