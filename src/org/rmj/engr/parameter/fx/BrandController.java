...
public class BrandController implements Initializable, IFXML {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        /*Initialize class*/
        poRecord = new XMBrand(poGRider, poGRider.getBranchCode(), false);
        ...
        switch (event.getCode()){
            case F3:
                if (lnIndex == 2){
                    ...
                    JSONObject lsResult = loInvType.searchInvType(txtField02.getText(), false);
    ...
    private void loadRecord(){
        ...
        if (poRecord.getMaster(2) != null && !poRecord.getMaster(2).toString().isEmpty()){
            XMInventoryType loInvType = new XMInventoryType(poGRider, poGRider.getBranchCode(), true);
            JSONObject lsResult = loInvType.searchInvType((String) poRecord.getMaster(2), true);
            loadInvType(lsResult);
        } else
            txtField02.setText("");
