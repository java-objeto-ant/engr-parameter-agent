package org.rmj.engr.parameter.fx;
...
public class Category4Controller implements Initializable, IFXML {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        /*Initialize class*/
        poRecord = new XMCategoryLevel4(poGRider, poGRider.getBranchCode(), false);
    ...
    private void txtField_KeyPressed(KeyEvent event) {
        ...
        switch (event.getCode()){
            case F3:
                if (lnIndex == 3){
                    XMCategory loCategory = new XMCategory(poGRider, poGRider.getBranchCode(), true);
                    JSONObject lsResult = loCategory.searchCategory(txtField03.getText(), false);
    ...
    private void loadRecord(){
        ...
        if (poRecord.getMaster(3) != null && !poRecord.getMaster(3).toString().isEmpty()){
            XMCategory loCategory = new XMCategory(poGRider, poGRider.getBranchCode(), true);
            JSONObject lsResult = loCategory.searchCategory((String) poRecord.getMaster(3), true);
            loadMaster(3, lsResult);
        } else
            txtField03.setText("");
    ...
    private final String pxeModuleName = "Category4Controller";
    private static GRider poGRider;
    private XMCategoryLevel4 poRecord;
        ...
        switch (fnIndex){
            case 3:
                if (fsResult != null && !fsResult.isEmpty()){
                    ...
                    poRecord.setMaster(3, (String) fsResult.get("sCategrCd"));
                    txtField03.setText(psMainCat);
                } else {
                    psMainCat = "";
                    poRecord.setMaster(3, "");
                    txtField03.setText("");
