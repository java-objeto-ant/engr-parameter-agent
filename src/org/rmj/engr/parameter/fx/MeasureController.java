...
public class MeasureController implements Initializable, IFXML {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        /*Initialize class*/
        poRecord = new XMMeasure(poGRider, poGRider.getBranchCode(), false);
    ...
    private final String pxeModuleName = "ColorController";
    private static GRider poGRider;
    private XMMeasure poRecord;
    ...
    final ChangeListener<? super Boolean> txtField_Focus = (o,ov,nv)->{
        ...
        if(!nv){ /*Lost Focus*/
            switch (lnIndex){
                case 2:
                    if (lsValue.length() > 15) lsValue = lsValue.substring(0, 14); 
