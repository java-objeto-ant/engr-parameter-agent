...
public class Category3Controller implements Initializable, IFXML {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        /*Initialize class*/
        poRecord = new XMCategoryLevel3(poGRider, poGRider.getBranchCode(), false);
    ...
    private final String pxeModuleName = "Category3Controller";
    private static GRider poGRider;
    private XMCategoryLevel3 poRecord;
